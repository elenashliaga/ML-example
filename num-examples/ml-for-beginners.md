...
Для вас скорее всего это уже будет подозрительно. Наивный байесовский классификатор же во время обучения выделит из текста письма слова, который указывают на спам, и будет их использовать для определения.
