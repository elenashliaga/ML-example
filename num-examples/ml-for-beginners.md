...
![image](https://github.com/elenashliaga/ML-example/assets/145377121/58765766-bfef-4570-9597-8df298c0973a)
...
1. Он смотрит на характеристики шариков и распределяет шарики на графике.
    ...
    ![Figure_1](https://github.com/elenashliaga/ML-example/assets/145377121/ef9fb957-de9d-44c1-8a5f-48755ba484e6)
...
2. На основе этих характеристик он находит лучшую линию для разделения шариков. Эта линия нарисована таким образом, чтобы красные шарики находились на одной стороне, а синие шарики — на другой.
    ...
    ![Figure_1_with_lines](https://github.com/elenashliaga/ML-example/assets/145377121/d027aca2-faa1-4663-bcd1-57cfba22ffaa)
...
Получатся две кривые зависимости вероятности встретить слово от слова для писем без спама и со спамом -- зеленая и красная соответсвенно.
...
![image](https://github.com/elenashliaga/ML-example/assets/145377121/527b96ef-f261-45d6-86dd-a4051cc94529)
...
![dataset-iris](https://github.com/elenashliaga/ML-example/assets/145377121/040fa29e-5448-4cfc-a8e3-a1942ed8c0b7)
...
![sphx_glr_plot_confusion_matrix_001](https://github.com/elenashliaga/ML-example/assets/145377121/b36f61d3-c9a8-4ccc-bf93-258e8c32cf88)


### Наивный байесовский классификатор

Наивный байесовский классификатор реализуется похожим образом. Пример разоран на том же датасете, что и линейный дискременантный анализ.
