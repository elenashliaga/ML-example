...
Может показаться, что машинное обучение основано на сложном наборе правил, но, на самом деле, оно построено на простых и понятных принципах. В этом статье я это и хочу показать.

Я разберу схему обучения моделей и немного математики, которая за ней стоит. В последнем разделе будет пример с кодом, на котором вы сможете обучить свою модель и проверить результаты.
