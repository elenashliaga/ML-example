...
* я разберу схемы обучения моделей;
* на двух простых примерах моделей для обчуения разберу немного математики, которая за всем стоит;
* в последнем разделе будут примеры кода для реализации разобранных моделей для обучения.
