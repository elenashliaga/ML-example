...
Для вас скорее всего это уже будет подозрительно. Наивный байесовский классификатор же во время обучения выделит из текста письма слова, который указыывают спам, и будет их исполльзовать для определения.
