...
Для наивного байесовского классификатор все окажется немного сложнее. Ему нужно сначала научиться, т.е. обработать существующие 500 писем, о которых известно спам это или не спам.
...
3. Повторит это для все встречающихся слов.
