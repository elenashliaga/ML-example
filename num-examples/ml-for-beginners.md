...
Для наивного байесовского классификатор все окажется немного сложнее. Ему придется обработать хотя бы 500 писем, которые будут известны как спам или не спам. Он построит вероятность встретить каждое слово в письме для спама и без спама.

Чтобы определить слова-указатели спама, он построит обе вероятности на одном графике.
